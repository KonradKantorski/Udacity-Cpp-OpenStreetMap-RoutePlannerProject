...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) 
{
    ...
    for(RouteModel::Node *i : current_node->neighbors) 
    {
        ...
        i->h_value = CalculateHValue(i); // h value for each neighbour
...
// -------- <algorithm> already included, same logic as in practice
...
void RoutePlanner::AStarSearch() 
{
    ...
    // TODO: Implement your solution here.                  -- Diagram provided shows logic
